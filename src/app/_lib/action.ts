...
export async function upsertUserAction(uuid: string, name: string, profileImageUrl: string) {
  return await createUser(uuid, name, profileImageUrl);
}

export const createChatAction = async (roomId: number, userId: number, message: string) => {
