...
export default async function Rooms() {
  ...
  if (!rooms || rooms.length === 0) return <div className="my-14">sorry... 参加可能なルームはありません🥹</div>;
      ...
      {rooms.map((room) => (
        ...
        >
          <div className="my-4 flex">
            <p className="mr-2 text-sm font-semibold text-blue-500 md:text-base">{room.name}</p>
            <JumpIcon />
          </div>
